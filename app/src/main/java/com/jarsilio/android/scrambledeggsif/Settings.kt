...
class Settings(private val context: Context) {
    ...
    var lastAlreadyScrambledProof: String
        get() = preferences.getString(LAST_ALREADY_SCRAMBLED_PROOF, "NO_PROOF-${UUID.randomUUID()}")
    ...
    companion object {
        val REWRITE_IMAGES = "pref_rewrite_images"
        val LAST_ALREADY_SCRAMBLED_PROOF = "pref_last_already_scrambled_proof"
        val KEEP_JPEG_ORIENTATION = "pref_keep_jpeg_orientation"
        val RENAME_IMAGES = "pref_rename_images"
    }
}
